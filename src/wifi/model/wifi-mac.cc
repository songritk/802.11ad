...
WifiMac::Configure80211ad_SC (void)
{
  ...
  SetCtsTimeout(GetSifs() + NanoSeconds(2909) + GetSlot() + GetMaxPropagationDelay() + GetMaxPropagationDelay());
  SetAckTimeout(GetSifs() + NanoSeconds(2909) + GetSlot() + GetMaxPropagationDelay() + GetMaxPropagationDelay());
}
...
WifiMac::Configure80211ad_OFDM (void)
{
  ...
  SetCtsTimeout(GetSifs() + NanoSeconds(2229) + GetSlot() + GetMaxPropagationDelay() + GetMaxPropagationDelay());
  SetAckTimeout(GetSifs() + NanoSeconds(2229) + GetSlot() + GetMaxPropagationDelay() + GetMaxPropagationDelay());
}
